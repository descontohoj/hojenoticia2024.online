...
Line 191:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 191:23 Transforming array spread to the configured target environment ("es5") is not supported yet
Line 193:4 Transforming const to the configured target environment ("es5") is not supported yet
Line 195:12 Transforming const to the configured target environment ("es5") is not supported yet
Line 196:12 Transforming const to the configured target environment ("es5") is not supported yet
Line 198:12 Transforming const to the configured target environment ("es5") is not supported yet
