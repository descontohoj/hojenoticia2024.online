...
var campaignID = "65b02e408c2cc60001534e8f";
...
var initialSrc = "https://track.portalequilibriodavida.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("track.portalequilibriodavida.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://track.portalequilibriodavida.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://track.portalequilibriodavida.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
